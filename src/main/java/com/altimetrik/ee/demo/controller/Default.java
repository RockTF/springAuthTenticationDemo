    ...
    if (deploymentEnv != null && !deploymentEnv.isEmpty()) {
      data =
          "<!DOCTYPE html>\n"
              ...
              + "  </tr>\n"
              + "  <tr>\n"
              + "    <td><a target='_blank' href='https://pgsandbox.altimetrik.com/project4554/project4554/'>https://pgsandbox.altimetrik.com/project4554/project4554/</a></td>\n"
              + "    <td>jdbc:h2:file:./src/main/resources/project4554</td>\n"
              + "    <td>playground</td>\n"
              + "    <td>password</td>\n"
              + "  </tr>\n"
              + "</table>\n"
