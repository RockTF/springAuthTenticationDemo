...
public class ComponentDetailsEntity {
  ...
  public boolean equals(Object obj) {
    ...
    if (componentIdentifier == null) {
      if (other.componentIdentifier != null) return false;
    } else if (!componentIdentifier.equals(other.componentIdentifier)) return false;
  ...
  public String toString() {
    return "ComponentDetailsEntity [id="
        + id
        + ", componentName="
        + componentName
        + ", componentIdentifier="
